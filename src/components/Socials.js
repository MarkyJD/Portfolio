...
export default function Socials({ mobile = false }) {
  if (mobile) {
    return (
      <div className="w-full flex justify-center space-x-5 mt-5">
        ...
        {/* LinkedIn */}
        <a
          href="https://www.linkedin.com/in/markydodson/"
          target="_blank"
          alt="LinkedIn"
          rel="noreferrer"
        >
  ...
  return (
    <div className="hidden lg:flex fixed z-20 inset-y-0 left-0 w-24 text-white flex flex-col items-center justify-end space-y-6">
      {/* Github */}
      <a
        href="https://github.com/MarkyJD"
        target="_blank"
